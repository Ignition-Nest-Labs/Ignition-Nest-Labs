...
function AboutUs() {
    return (
        <div className='container mx-auto px-4 md:px-6 mt-12 lg:px-8 flex flex-col items-center justify-start' id='about'>
            ...
            <div className='flex  flex-col md:flex-row items-stretch gap-x-6 w-full md:px-40 mt-10'>
                <div className='flex flex-col sm:flex-row items-center justify-around  px-5 border-2 border-[#1E1E1E] rounded-[25px] bg-gradient-to-b from-[#131313] to-[#070707] flex-grow'>
                ...
                <div className='md:flex hidden flex-col justify-center items-center px-5 py-4 border-2 border-[#1E1E1E] rounded-[25px] bg-gradient-to-b from-[#131313] to-[#070707] flex-grow'>
            ...
            <div className='flex flex-row items-stretch gap-x-6 w-full md:px-40 mt-5 md:mt-10'>
                <div className='hidden md:flex flex-col justify-center items-center px-5 py-4 border-2 border-[#1E1E1E] rounded-[25px] bg-gradient-to-b from-[#131313] to-[#070707] flex-grow'>
                    <h1 className='font-bold text-xl text-center text-white'>Social media and <br /> Branding Services</h1>
                </div>
                <div className='flex flex-col md:flex-row items-center justify-between   border-2 border-[#1E1E1E] rounded-[25px] bg-gradient-to-b from-[#131313] to-[#070707] flex-grow'>
